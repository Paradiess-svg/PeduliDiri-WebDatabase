    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3 text-success">Peduli Diri</div>
            </a>
                    ...
                    <div class="mb-4 text-gray-800">
                        ...
                        if(!empty($url)){
                            switch ($url) {
                                ...
                                default:
                                echo"Halaman Tidak Temukan";
                                    break;
                            }
                        }else{
                            echo "<h5>Selamat Datang di Peduli Diri, Aplikasi Ini Digunakan Untuk Mencatat Riwayat Perjalanan Anda.</h5>";
                            echo "<h5><b>Karena diri sendiri lebih penting dari orang lain.</h5><br>";
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Aplikasi Peduli Diri Paradiess-svg 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
